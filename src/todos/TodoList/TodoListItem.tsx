          ...
          ? (
            <ul>
              {todoList.map((todo: Todo) => {
                ...
                const isUpdating = pending.updating?.id === todo.id
                const isDeleting = pending.deleting?.id === todo.id
                ...
                return (
                  <TodoItem
                    ...
                    error={}
                    redoAction={pending.updating ? saveTodo : pending.deleting ? remove : null}
                  />
                )
              })}
              {pending.creating &&
